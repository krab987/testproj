...
namespace Lab_10.Module.MainClasses
{
    ...
    public class Team
    {
        ...
        {
            DelegateInt myDelegateInt = new DelegateInt(SetSalaryTeamlead);
            teamlead.Salary = myDelegateInt();
            myDelegateInt += SetSalaryTeam;
            salaryTeam = myDelegateInt();
