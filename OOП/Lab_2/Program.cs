    ...
    if (current <= count_el)
    {
        ...
        while (true)
        {
            try
            {
                ...
                myCvs[current].SetAdress(Console.ReadLine());
                break;
            }
            catch (Exception ex)
            {
        ...
        while (true)
        {
            try
            {
                ...
                myCvs[current].SetAge(Convert.ToInt16(Console.ReadLine()));
                break;
            }
            catch (Exception ex)
            {
        ...
        while (true)
        {
            try
            {
                ...
                myCvs[current].SetTelephone(Convert.ToInt32(Console.ReadLine()));
                break;
            }
            catch (Exception)
            {
        ...
        while (true)
        {
            try
            {
                ...
                myCvs[current].SetExperience(Convert.ToInt32(Console.ReadLine()));
                break;
            }
            catch (Exception ex)
            {
...
void FindEl(int current, CV[] myCvs)
{
    ...
    Console.WriteLine("Do u want to fill:");
    ...
    while (true)
    {
        try
        {
            ...
            if (formatIndex > (int)WtFormat.LastName_Fn)
                throw new Exception("I can`t find it");
            myCvs[indFormat].FormatSearch(formatIndex);
            break;
        }
