...
public class Program
{
    ...
    private static void SortElInTeams(Office myOffice)
    {
    ...
    private static void FillDocuments(Office myOffice)
    {
        while (true)
        {
            try
    ...
    private static void InputCamperz(Office myOffice)
    {
        string[] temp;
    ...
    private static void FinishProjects(Office myOffice)
    {
        while (true)
        {
            try
    ...
    private static void InputTeams(Office myOffice)
    {
